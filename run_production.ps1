...
function Start-ProductionServer {
    ...
    if (Test-Path ".env.production") {
        Write-Host "Copiando configuración de producción..."
    ...
    if (Test-Path "C:\oracle") {
        ...
        Write-Host "Por favor, verifica la instalación del cliente Oracle" -ForegroundColor Yellow
    ...
    # Preparar entorno
    Write-Host "`nPreparando entorno de producción..."
    ...
    $env:DJANGO_SETTINGS_MODULE = "webVulcano.settings_production"
